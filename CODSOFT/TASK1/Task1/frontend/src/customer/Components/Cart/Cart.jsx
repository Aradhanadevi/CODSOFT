...
const Cart = () => {
  ...
  return (
    <div className="">
      ...
      >
        <div className="border p-5 bg-white shadow-md shadow-black rounded-md"style={{background:"#e8ba88", color:"#463f6a"}}>
          <p className="font-bold opacity-60 pb-4">PRICE DETAILS</p>
          <hr />

          <div className="space-y-3 font-semibold" style={{color:"#463f6a"}}>
            <div className="flex justify-between pt-3 " style={{color:"#463f6a"}}>
